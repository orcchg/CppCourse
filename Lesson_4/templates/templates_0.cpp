...
int main(int argc, char** argv) {
  ...
  INF("Sorting <Node>");
  print(node_array, 10);
  std::sort(node_array, node_array + 10);
  print(node_array, 10);

  DBG("[Lesson 4]: Templates 0 [END]");
  return 0;
}
