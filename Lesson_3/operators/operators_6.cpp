...
public:
  ...
  // TODO: implement other operations: -, *, /, ==, !=, unary + and -, ++, --
  // TODO: implement assigments: -=, *=, /=
...
int main(int argc, char** argv) {
  DBG("[Lesson 3]: Operators 6");

  Complex first = input();
  Complex second = input();
  Complex third = input();

  std::cout << "Первое + второе: " << first + second << "\n";  // Quiz: where ~Destructor is called?
  std::cout << "Второе + третье: " << second + third << "\n";

  DBG("Third += First");
  third += first;
  std::cout << "Третье увеличенное: " << third << std::endl;

  DBG("[Lesson 3]: Operators 6 [END]");
  return 0;
}
