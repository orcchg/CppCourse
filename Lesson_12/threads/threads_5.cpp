...
int UniqueNumberGenerator::next() {
  return m_unique_number++;  // Not atomic operation
}
...
void Checker::test(IntGenerator* generator, CircularBuffer* buffer) {
  INF("Start unique value: %i", UniqueNumberGenerator::startValue);
